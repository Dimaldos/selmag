...
import ru.dimaldos.selmag.catalogueservice.controller.payload.NewProductPayload;
...
public class ProductsRestController {
    ...
    @GetMapping
    public Iterable<Product> findProducts(@RequestParam(required = false) String filter) {
